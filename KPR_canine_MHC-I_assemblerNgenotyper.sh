...
mkdir $result_tmp/AssemblyResult
cd $result_tmp
...
### Forwd ###
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon2_forwardStrandReads.fa-pair DLA_Exon2_reverseStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon2_contigs-'$K'mer_'$N'.txt'
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon2-3_forwardStrandReads.fa-pair DLA_Exon2-3_reverseStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon2-3_contigs-'$K'mer_'$N'.txt'
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon3_forwardStrandReads.fa-pair DLA_Exon3_reverseStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon3_contigs-'$K'mer_'$N'.txt'

cd $result_tmp/AssemblyResult
...
cd $result_tmp
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon2_reverseStrandReads.fa-pair DLA_Exon2_forwardStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon2_contigs-'$K'mer_'$N'-REV.txt'
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon2-3_reverseStrandReads.fa-pair DLA_Exon2-3_forwardStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon2-3_contigs-'$K'mer_'$N'-REV.txt'
python $script_assembler/Kmer_assembly4_V6.py DLA_Exon3_reverseStrandReads.fa-pair DLA_Exon3_forwardStrandReads.fa-pair $K $N 3 > AssemblyResult/'Kmer_Exon3_contigs-'$K'mer_'$N'-REV.txt'
...
assembly_merge=$result_tmp'/MergedContigs'
mkdir $assembly_merge
cd $assembly_merge

cat $result_tmp/AssemblyResult/*merged-Match > sample_contigs.fa # Merge all contigs
...
if [ -f $result_tmp/sample_BWA_reads.sam ]
then
cp $result_tmp/sample_BWA_reads.sam $result_files
fi

if [ -f $assembly_merge/DLA12_contigs.txt ]
then
cp $assembly_merge/DLA12_contigs.txt $result_files
fi

if [ -f $assembly_merge/DLA64_contigs.txt ]
then
cp $assembly_merge/DLA64_contigs.txt $result_files
fi

if [ -f $assembly_merge/DLA88-50X_contigs.txt ]
then
cp $assembly_merge/DLA88-50X_contigs.txt $result_files
fi

if [ -f $assembly_merge/DLA88-norm_contigs.txt ]
then
cp $assembly_merge/DLA88-norm_contigs.txt $result_files
fi

if [ -f $assembly_merge/nonDLA64/combined/Filtering/PolymorphicSites_nucleotide_freq.txt ]
then
cp $assembly_merge/nonDLA64/combined/Filtering/PolymorphicSites_nucleotide_freq.txt $result_files
fi

if [ -f $assembly_merge/nonDLA64/combined/Filtering/Pairwise_position_counts.txt ]
then
cp $assembly_merge/nonDLA64/combined/Filtering/Pairwise_position_counts.txt $result_files
fi

if [ -f $assembly_merge/nonDLA64/combined/Filtering/Pairwise_linkage.txt ]
then
cp $assembly_merge/nonDLA64/combined/Filtering/Pairwise_linkage.txt $result_files
fi

if [ -f $assembly_merge/nonDLA64/combined/Filtering/ReadPair_polySite_linkages.txt ]
then
cp $assembly_merge/nonDLA64/combined/Filtering/ReadPair_polySite_linkages.txt $result_files
fi
